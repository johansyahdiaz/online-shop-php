...
!(function (a, b) {
  ...
  function ha(a, b) {
    for (var c, d, e = [], f = 0, g = a.length; f < g; f++)
      (d = a[f]),
        d.style &&
          ((c = d.style.display), b ? ("none" === c && ((e[f] = V.get(d, "display") || null), e[f] || (d.style.display = "")), "" === d.style.display && ca(d) && (e[f] = ga(d))) : "none" !== c && ((e[f] = "none"), V.set(d, "display", c)));
  ...
  r.extend({
    ...
    ajax: function (b, c) {
      ...
      if (
        (s.promise(y), (o.url = ((b || o.url || qb.href) + "").replace(Eb, qb.protocol + "//")), (o.type = c.method || c.type || o.method || o.type), (o.dataTypes = (o.dataType || "*").toLowerCase().match(K) || [""]), null == o.crossDomain)
      ) {
        j = d.createElement("a");
        try {
